...
def fasttree():
    ...
    #fasttree tree
    FastTree_cmd = "./FastTreeMP -nt -spr 4 -mlacc 2 -slownni -gtr -gtrrates 1.000000 8.56 1.000000 1.000000 8.56 1.000000 -gtrfreq 0.25 0.25 0.25 0.25 " + gblocks_cleaned_file_path + " > "  + result_dir + project_name +  "_fastTree_tree.txt"
